...
jsonl_file_path = 'processed_dataset_csv_3M_5M_v2.jsonl'
...
with open("processed_dataset_csv_3M_5M_v2.jsonl",'w') as file:
...
with open("processed_dataset_csv_3M_5M_v2.jsonl",'r') as file:
